...
<?php 
    $paypal = $wpdb->get_var($wpdb->prepare("SELECT option_value FROM bpm_settings WHERE option_name = 'paypal';")); 
    $message = $wpdb->get_var($wpdb->prepare("SELECT option_value FROM bpm_settings WHERE option_name = 'message';"));
    $btn_en = $wpdb->get_var($wpdb->prepare("SELECT option_value FROM bpm_settings WHERE option_name = 'button_en';"));
    $btn_text = $wpdb->get_var($wpdb->prepare("SELECT option_value FROM bpm_settings WHERE option_name = 'button_text';"));
    $btn_link = $wpdb->get_var($wpdb->prepare("SELECT option_value FROM bpm_settings WHERE option_name = 'button_link';"));
