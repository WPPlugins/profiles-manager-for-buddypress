...
global $wpdb;
    ...
    $pay_email = $wpdb->get_var($wpdb->prepare("SELECT option_value FROM bpm_settings WHERE option_name = 'paypal';"));
    ...
    foreach ($get_items as $item) {
        ...
        echo <<<CONTENT
            <td>
                ...
                <input type="hidden" name="currency_code" value="$item->currency">
